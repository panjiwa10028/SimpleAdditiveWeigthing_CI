...
<form id="form_input" action="<?= site_url('dashboard/daftar_proses/edit'); ?>" method="post" class="form-vertical" enctype="multipart/form-data">
   <div class="row">
      <div class="col-md-4">
         <?= $kolom1; ?>
      </div>
   ...
   <hr />
   <button type="submit" class="btn btn-primary btn-lg"><i class="fa fa-check"></i> SIMPAN PERUBAHAN</button>
   <a href="<?= site_url('dashboard/profil_petugas'); ?>" class="btn btn-warning btn-lg"><i class="fa fa-times"></i> BATAL</a>
</form>
